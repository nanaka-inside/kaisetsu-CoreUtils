...
ここのところ、1年ほどで在庫が払底し、次の版を出すペースで来ておりましたが今回は遅くなりました。理由は印刷費がなかったのです！今この本の印刷費が出せるかどうかの瀬戸際でして、なんとかしています。いつもの印刷所なので交渉してます。そういうこともあります。こんなことは2回目です。おい！

さてアップデートのコーナーですが、バージョンアップは・・・・ありました。これを書いている12日前のことでした。 ``basenc`` コマンドが追加されたのが一番大きなところでしょうか。
